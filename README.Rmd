...
Wagedown aims to provide the Rmarkdown template for PhD candidate in Wageningen University, the Netherlands. The Wagedown in now being built based on thesisdown.
